document.addEventListener('DOMContentLoaded', () => {
    ...
    // Bezpečné URL - volá naši novou Cloudflare Function
    const API_URL = '/api';
    ...
    async function nactiMenu() {
        try {
            // Odeslání dotazu bez nutnosti přikládat tajný klíč
            const odpoved = await fetch(API_URL);
            
            if (!odpoved.ok) throw new Error('Nepodařilo se načíst data z API.');
